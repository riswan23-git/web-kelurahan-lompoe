...
module.exports = (req, res) => {
    try {
        ...
        const ttlMeninggalVal = getNonEmpty(extraJson.tgl_lahir_meninggal, item.tgl_lahir_meninggal, extraJson['tgl_lahir_meninggal']) || tempatTglLahirVal;
        const jkMeninggalVal = getNonEmpty(extraJson.jk_meninggal, extraJson.jenis_kelamin_meninggal, item.jk_meninggal) || jenisKelaminVal;
        const agamaMeninggalVal = getNonEmpty(extraJson.agama_meninggal, item.agama_meninggal) || agamaVal;
        ...
        const payload = {
            ...
            'penggunaan izin': safeStr(extraJson.hiburan_acara || extraJson.penggunaan_izin || item.hiburan_acara || item.penggunaan_izin || extraJson['penggunaan izin'] || extraJson.hiburan || extraJson.alat_musik || item.penggunaan_izin, 'Musik Elekton / Sound System'),
            'Penggunaan Izin': safeStr(extraJson.hiburan_acara || extraJson.penggunaan_izin || item.hiburan_acara || item.penggunaan_izin || extraJson['penggunaan izin'] || extraJson.hiburan || extraJson.alat_musik || item.penggunaan_izin, 'Musik Elekton / Sound System'),
            'penggunaan_izin': safeStr(extraJson.hiburan_acara || extraJson.penggunaan_izin || item.hiburan_acara || item.penggunaan_izin || extraJson['penggunaan izin'] || extraJson.hiburan || extraJson.alat_musik || item.penggunaan_izin, 'Musik Elekton / Sound System'),
            'hiburan_acara': safeStr(extraJson.hiburan_acara || extraJson.penggunaan_izin || item.hiburan_acara || item.penggunaan_izin || extraJson['penggunaan izin'] || extraJson.hiburan || extraJson.alat_musik || item.penggunaan_izin, 'Musik Elekton / Sound System'),
            'hiburan': safeStr(extraJson.hiburan_acara || extraJson.penggunaan_izin || item.hiburan_acara || item.penggunaan_izin || extraJson['penggunaan izin'] || extraJson.hiburan || extraJson.alat_musik || item.penggunaan_izin, 'Musik Elekton / Sound System'),
