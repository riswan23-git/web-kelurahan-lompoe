...
const defaultPengajuanList = [
    {
        ...
        keperluan: 'Syukuran & Pesta Pernikahan',
        nama_acara: 'Syukuran & Pesta Pernikahan',
        hiburan_acara: 'Musik Elekton / Sound System',
        tanggal_acara: 'Senin, 24 Agustus 2026',
        lokasi_acara: 'Gedung Gelora Lompoe',
        status_rt: 'Menunggu Verifikasi RT',
        status_rw: 'Menunggu Verifikasi RW',
        status_kelurahan: 'Progres',
        status: 'Progres',
        token_rt: 'LMP-891472_RT',
        token_rw: 'LMP-891472_RW',
    ...
    },
    {
        ...
        status_kelurahan: 'Progres',
        status: 'Progres',
        token_rt: 'LMP-102938_RT',
        token_rw: 'LMP-102938_RW',
        tgl_pengajuan: '2026-08-17',
        tanggal_pengajuan: '2026-08-17',
    ...
    },
    {
        id: 103,
        no_resi: 'LMP-816794',
        nomor_resi: 'LMP-816794',
        nama_pemohon: 'Asep',
        nama_lengkap: 'Asep',
        nik: '7377273773838383',
        tempat_tgl_lahir: 'Parepare, 10 Juni 1996',
        jenis_kelamin: 'Laki-laki',
        agama: 'Islam',
        pekerjaan: 'Wiraswasta',
        ...
        jenis_surat: 'Surat Izin Keramaian',
        rt_rw: 'RW 01 / RT 01',
        telepon: '089602366786',
        no_hp: '089602366786',
        nomor_wa: '089602366786',
        keperluan: 'Pesta pernikahan',
        nama_acara: 'Pesta pernikahan',
        hiburan_acara: 'Musik Elekton / Sound System',
        status_rt: 'Disetujui RT (Ketua RT (Pak Bustan))',
        status_rw: 'Disetujui RW (Ketua RT Riswang)',
        status_kelurahan: 'Disetujui/Siap Diambil',
        status: 'Disetujui/Siap Diambil',
        token_rt: 'LMP-816794_RT',
        token_rw: 'LMP-816794_RW',
        tgl_pengajuan: '2026-08-22',
        tanggal_pengajuan: '2026-08-22',
        file_berkas: 'IMG_3843.png'
    },
    {
        id: 104,
        no_resi: 'LMP-451803',
        nomor_resi: 'LMP-451803',
        nama_pemohon: 'Kurni',
        nama_lengkap: 'Kurni',
        nik: '7378826373899399',
        tempat_tgl_lahir: 'Parepare, 05 Juli 1997',
        jenis_kelamin: 'Laki-laki',
        agama: 'Islam',
        pekerjaan: 'Wiraswasta',
        alamat: 'Jl. Poros Lompoe No. 19',
        jenis_surat: 'Surat Izin Keramaian',
        rt_rw: 'RW 01 / RT 01',
        telepon: '089602366786',
        no_hp: '089602366786',
        ...
        nama_acara: 'Syukuran',
        hiburan_acara: 'Musik Elekton / Sound System',
        status_rt: 'Disetujui RT (Ketua RT (Pak kadip))',
        status_rw: 'Disetujui RW (Ketua RT (Pak surya))',
        status_kelurahan: 'Progres',
        status: 'Progres',
        token_rt: 'LMP-451803_RT',
        token_rw: 'LMP-451803_RW',
        tgl_pengajuan: '2026-08-22',
        tanggal_pengajuan: '2026-08-22',
        file_berkas: 'Surat_Pengantar.pdf'
    }
];

const globalStore = global.__LOMPOE_STORE__ || {
    aparatur: defaultAparaturList,
    ...
    pengajuanList: defaultPengajuanList,
    chatMessages: [
