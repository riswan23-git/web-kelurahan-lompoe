...
fs.writeFileSync(path.join(apiDir, 'uploads.js'), uploadsCode, 'utf8');
console.log('Successfully created api/uploads.js!');
...
const vercelConfig = {
  ...
  "rewrites": [
    { "source": "/uploads/:path*", "destination": "/api/uploads" },
    { "source": "/uploads", "destination": "/api/uploads" },
    { "source": "/api/uploads/:path*", "destination": "/api/uploads" },
    { "source": "/api/uploads", "destination": "/api/uploads" },
    { "source": "/api/download-surat-selesai/:path*", "destination": "/api/uploads" },
    { "source": "/api/download-surat-selesai", "destination": "/api/uploads" },
